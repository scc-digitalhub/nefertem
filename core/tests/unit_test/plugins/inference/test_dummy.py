import pytest
from nefertem_core.plugins.inference.dummy import InferenceBuilderDummy, InferencePluginDummy
from nefertem_core.utils.commons import DUMMY, FILE_READER, INFER
